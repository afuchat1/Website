...
export const getGetCommunityMembersUrl = (params?: GetCommunityMembersParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/community/members?${stringifiedParams}` : `/api/community/members`
}
 ...
 */
export const getCommunityMembers = async (params?: GetCommunityMembersParams, options?: RequestInit): Promise<CommunityMembersResponse> => {

  return customFetch<CommunityMembersResponse>(getGetCommunityMembersUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getGetCommunityMembersQueryKey = (params?: GetCommunityMembersParams,) => {
    return [
    `/api/community/members`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetCommunityMembersQueryOptions = <TData = Awaited<ReturnType<typeof getCommunityMembers>>, TError = ErrorType<unknown>>(params?: GetCommunityMembersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCommunityMembers>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetCommunityMembersQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getCommunityMembers>>> = ({ signal }) => getCommunityMembers(params, { signal, ...requestOptions });
...
export function useGetCommunityMembers<TData = Awaited<ReturnType<typeof getCommunityMembers>>, TError = ErrorType<unknown>>(
 params?: GetCommunityMembersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCommunityMembers>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetCommunityMembersQueryOptions(params,options)
