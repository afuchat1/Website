...
import {illSvcAfumail, illSvcAfuchat, illSvcAfuai, illSvcAfucloud,
...
export const PRODUCT_DATA: ProductData[] = [
  ...
  },
  {
    id: "afumovies",
    name: "AfuMovies",
    tagline: "Discover what is worth watching.",
    category: "Movie & TV discovery",
    description: "A research-grade movie and TV discovery library with cast, crew, ratings, trailers, box office, keywords, and where-to-watch information.",
    features: ["Deep title research", "Cast & crew", "Where to watch"],
    color: "#EF4444",
    bgColor: "#FEE2E2",
