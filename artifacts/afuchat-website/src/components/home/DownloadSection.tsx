      ...
      <div className="max-container container-pad flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        >
          ...
          <a
            ...
            className="flex items-center gap-3 bg-white/8 border border-white/15 text-white px-6 py-3.5 rounded-xl hover:bg-white/14 transition-colors w-full sm:w-auto justify-center"
          >
