      ...
      <div className="max-container py-12 sm:py-14">
        ...
        <div className="trusted-by-marquee" aria-label="Companies AfuChat has worked with">
          <div className="trusted-by-track">
            ...
            [
              ['AJS Digital Services & IT Solutions', '/partners/ajs-digital-services.png'],
              ['Mindset Media Radio', '/partners/mindset-media-radio.png'],
              ['Amazon Shoe Collection', '/partners/amazon-shoe-collection.png'],
              ['Sabula Shoe Spot', '/partners/sabula-shoe-spot.png'],
              ['Bee brand', '/partners/bee-brand.png'],
