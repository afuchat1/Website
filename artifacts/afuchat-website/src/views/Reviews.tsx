        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-10 md:mb-14">
          <div className="col-span-1 sm:col-span-2 md:col-span-1">
            ...
            <div className="flex flex-col items-start gap-3 mb-5">
              <a href="https://www.trustpilot.com/review/afuchat.com" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-white/90 transition-colors rounded-md px-3 py-1.5 flex items-center"><img src={_FT} alt="Trustpilot" className="h-8 w-auto" loading="lazy" /></a>
