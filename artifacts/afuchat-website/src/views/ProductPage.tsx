...
export default function ProductPage({ id }: { id: string }) {
  ...
  return <div className={product!.id === 'engagera' ? 'studio-shell engagera-page' : 'studio-shell'}>
    <section className={`max-container studio-section grid items-center gap-12 lg:grid-cols-[.92fr_1.08fr] lg:gap-24 ${product!.id === 'engagera' ? 'engagera-hero-section' : ''}`}>
