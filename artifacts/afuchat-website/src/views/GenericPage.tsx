...
const PAGE_CONTENT: Record<string, {
  ...
  press: {
    accent: '#3B82F6', illustration: illSecPress,
    sections: [
  ...
  help: {
    accent: '#14B8A6', illustration: illSecHelp,
    sections: [
...
const fallback = {
  accent: '#1F95FF',
  sections: [
    { heading: 'Overview', body: 'AfuChat Technologies Limited is committed to providing secure, reliable, independent products for all your digital needs.' },
    { heading: 'Our commitment', body: 'We are constantly updating our resources to provide the most accurate and complete information.' },
  ],
};

export default function GenericPage({ title, type }: GenericPageProps) {
  const content = PAGE_CONTENT[type.toLowerCase()] ?? fallback;
