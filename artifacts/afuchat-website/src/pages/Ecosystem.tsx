...
export default function Ecosystem() {
  return (
    <div
      ...
      style={{
        background: `
          radial-gradient(ellipse at 70% 20%, rgba(14,80,200,0.40) 0%, transparent 55%),
          radial-gradient(ellipse at 15% 60%, rgba(80,30,200,0.25) 0%, transparent 50%),
          radial-gradient(ellipse at 50% 90%, rgba(0,140,180,0.18) 0%, transparent 45%),
          #060e22
        `,
      }}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p className="text-lg text-white/55 max-w-xl leading-relaxed mb-8">
              AfuChat is not a single app — it's a living ecosystem. Eight specialized services share one identity, one payment method, and one place to manage them all. When services talk to each other, your experience becomes seamless in ways no single app can match.
            </p>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex gap-4">
              <Link href="/signup" className="px-7 py-3.5 bg-[#1F7AFF] text-white font-bold text-sm rounded-xl hover:bg-[#1468E0] transition-colors">Create free account →</Link>
