        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link href="#" className="flex items-center justify-center px-6 py-3.5 bg-[#16C784] text-white font-semibold text-sm rounded-full hover:bg-[#12b070] transition-colors w-full sm:w-auto">
                Read documentation
              </Link>
              <Link href="#" className="flex items-center justify-center px-6 py-3.5 border border-white/15 text-white/60 font-medium text-sm rounded-full hover:border-white/30 hover:text-white transition-colors w-full sm:w-auto">
                View on GitHub
              </Link>
            </div>
          </motion.div>
